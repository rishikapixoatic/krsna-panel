                ...
                {currentStep === 2 && (
                  <>
                    ...
                    <div className="flex justify-between">
                      ...
                      <button className="group relative flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-gray-800 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500" onClick={() => setCurrentStep(3)}>
                        Next
                      </button>
                    </div>
                  </>
